...
/**Ta funkcja zamienia i zwraca liczbê wprowadzon¹ przez tablice znakow
	@param *number wskznik na funkcje is_numbers
	@param thisString[] tablica znkow do zamiany
*/
...
/**Ta funkcja usuwa gracza o podanym numerze
	@param **lista_pointer wskaznik na liste graczy	
	@param number to index gracza ktory ma zostac usuniety
*/
...
/**Ta funkcja to tryb gry oparty na zasadach wyœcigu trybu losowych pytan calego quizu
	@param **lista_pointer wskaznik na liste graczy
*/
void random_question_mode_race(struct players** players_list);
/**Ta funkcja to tryb gry oparty na wyœcigu trybu standardowego
	@param **lista_pointer wskaznik na liste graczy
*/
